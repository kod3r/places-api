...
exports = module.exports = [{
  ...
  'process': function(req, res) {
    ...
    if (req.query.unit_code) {
      req.params.typeArray = '^' + req.query.unit_code.split(',').join('$|^') + '$';
      queryArray.push('tags -> \'nps:alphacode\' ~* \'{{unit_code}}\' AND');
    }
