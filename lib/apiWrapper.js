...
var addMethod = function(method, path, version, format, router, auth, callback) {
  ...
  if (inFormat) {
    router[method](newPath, inFormat, newResult(auth, callback));
  } else {
    router[method](newPath, newResult(auth, callback));
  }
...
exports = module.exports = function(router) {
  return {
    allow: function(method, path, version, format, auth, callback) {
      addMethod(method, path, version, format, router, auth, callback);
    }
  };
};
