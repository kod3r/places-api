...
DROP TABLE current_node_tags CASCADE;
...
DROP TABLE current_relation_members CASCADE;
...
DROP TABLE current_relation_tags CASCADE;
...
DROP TABLE current_relations CASCADE;
...
DROP TABLE current_way_nodes CASCADE;
